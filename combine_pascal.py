...
tf.app.flags.DEFINE_string(
    'data_dir', 'D:/graduate/code/combine/code/data/tfrecords/VOC2007/TF_test/', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_integer(
    'labels_offset', 0,
...
tf.app.flags.DEFINE_string(
    'model_name', 'combine', 'The name of the architecture to train.')
tf.app.flags.DEFINE_string(
...
def save_image_with_bbox(image, labels_, scores_, bboxes_):
    ...
    imageio.imwrite(os.path.join('D:/graduate/code/combine/code/Debug', '{}.jpg').format(save_image_with_bbox.counter), img_to_draw)
    ...
    with tf.device('/cpu:0'):
        ...
        with tf.device('/gpu:0'):
            ...
            slim.learning.train(
                ...
                summary_writer=tf.summary.FileWriter('D:/graduate/code/combine/code/summary_pascal'),
                saver=saver,
