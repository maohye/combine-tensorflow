...
from nets import combine_net
from nets import combine_net_kitti

slim = tf.contrib.slim

networks_map = {
                'combine': combine_net.combine_net,
                'combine_kitti': combine_net_kitti.combine_net,
                'ssd_300_vgg': ssd_vgg_300.ssd_net,
                'ssd_300_vgg_caffe': ssd_vgg_300.ssd_net,
                }

arg_scopes_map = {'combine': combine_net.combine_arg_scope,
